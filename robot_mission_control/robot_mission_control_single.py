...
class MissionControlActionServer(Node):
    def __init__(self):
        ...
        self.declare_parameter("robot_namespace_param", "robot1")
        robot2_namespace = (
            self.get_parameter("robot_namespace_param")
            .get_parameter_value()
            .string_value
        )
        self.get_logger().info(f"robot namespace is {robot2_namespace}")
    ...
    def publish_mission_control_feedback(self):
        ...
        if self._robot_2_input_feedback_pose and self._robot_2_input_feedback_state:
    ...
    def execute_callback(self, goal_handle):
        ...
        self.get_plan_request.start = [start_goal_robot2]
        self.get_plan_request.goal = [end_goal_robot2]
